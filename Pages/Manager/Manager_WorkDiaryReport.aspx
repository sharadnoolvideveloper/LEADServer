<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Manager/Manager.master" AutoEventWireup="true" CodeFile="Manager_WorkDiaryReport.aspx.cs" Inherits="Pages_Manager_Manager_WorkDiaryReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        function SearchCategoryManagerName() {
            var input, filter, ul, li, a, i;
            input = document.getElementById("txtCategoryManagerSearch");
            filter = input.value.toUpperCase();
                    ...
                    <div id="SubCatWisetab" runat="server" class="tab-pane brandFont">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row" id="CategoryList">
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-12" style="height: 650px; overflow: auto">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <ul class="list-group brandFont">
                                                        <li class="list-group-item">
                                                            <asp:LinkButton ID="btnAllCategory" ValidationGroup="CategoryWise" OnClick="btnAllCategory_Click" runat="server">
                                                                All
