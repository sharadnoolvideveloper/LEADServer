...
public partial class Pages_Manager_Manager_ScheduleMessaging : System.Web.UI.Page
{
            ...
            if (cook.Manager_Id() != null)
            {
               ...
               ;
                ...
                if(btnType=="Edit")
                {
                    ...
                    ddlHours.SelectedIndex = ddlHours.Items.IndexOf(ddlHours.Items.FindByValue(ScheduleDate.Hour.ToString()));
