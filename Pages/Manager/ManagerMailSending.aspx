<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Manager/Manager.master" AutoEventWireup="true" CodeFile="ManagerMailSending.aspx.cs" Inherits="Pages_Manager_ManagerMailSending" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <asp:LinkButton ID="btnSMSMain" CssClass="btn btn-primary" OnClick="btnSMSMain_Click" runat="server"> SMS / Notification &nbsp; <span class="fa fa-phone"></span> </asp:LinkButton>
                                </div>
                            </div>
                            ...
                            <div class="panel-body" style="overflow: auto; height: 670px;">
                                <asp:MultiView ID="MultiView1" runat="server">
                                    <asp:View ID="vwSMS" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:TextBox ID="txtSMSMessage" runat="server" CssClass="form-control" Rows="6" Columns="6"
                                                    TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="panel-footer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <asp:Button ID="BtnSendNotification" OnClick="BtnSendNotification_Click" CssClass="btn btn-facebook btn-block" OnClientClick="this.disabled = true;this.value='Notification Sending Please Wait...';" UseSubmitBehavior="False" runat="server" Text="Send Notification" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <%-- <asp:LinkButton ID="btnSendSMS" OnClick="btnSendSMS_Click" runat="server" CssClass="btn btn-primary btn-block">Send SMS &nbsp;  <span class="fa fa-send"></span>  </asp:LinkButton>--%>
                                                </div>
                                            </div>
                                        </div>
                                    </asp:View>
